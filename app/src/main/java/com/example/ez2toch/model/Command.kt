...
sealed class Command {
    ...
    data class Swipe(val startX: Int, val startY: Int, val endX: Int, val endY: Int, val duration: Long) : Command()
    data class LongPress(val x: Int, val y: Int, val duration: Long) : Command()
    object Stop : Command()
    data class Comment(val text: String) : Command()
    
    // Conditional commands
    data class If(val condition: String, val thenCommands: List<Command>, val elseCommands: List<Command> = emptyList()) : Command()
